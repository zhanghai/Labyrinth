...
public class ProducationRenders {
    ...
    private static int sViewProjectionMatrixUniform,sViewProjectionMatrixUniform2;
...
//    };
    ...
    static {
        ...
        sCircleBallVertexBuffer.put(genCircle2d(0.05f,sPoints,0,0));
    ...
    public static void initialize() throws IOException {
        ...
        sViewProjectionMatrixUniform2 = GlUtils.getUniformLocation(sPrototypeProgram2,
                "uViewProjectionMatrix");
    ...
    public static void setViewProjectionMatrix(Matrix4f viewProjectionMatrix) {
        ...
        System.out.println(sBallX+ " " + sBallY);
        glUniformMatrix4fv(sViewProjectionMatrixUniform, false,
                viewProjectionMatrix.identity().translate(sBallX,sBallY,0).rotateX(00f).rotateZ(0).get(sViewProjectionMatrixBuffer));

        glUseProgram(0);
        glUseProgram(sPrototypeProgram2);

        glUniformMatrix4fv(sViewProjectionMatrixUniform2, false,
                viewProjectionMatrix.identity().translate(sBallX,sBallY,0).rotateX(00f).rotateZ(0).get(sViewProjectionMatrixBuffer));
    ...
    private static Matrix4f getModelMatrixForWall(Wall wall) {
        return getModelMatrix(wall).translate((float) wall.getPositionX(),(float) wall.getPositionY(),0f).scale((float) wall.getWidth(),
