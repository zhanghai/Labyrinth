...
import cn.edu.zju.cs.graphics.labyrinth.rendering.*;
...
public class LabyrinthApplication implements Labyrinth.Listener {
    ...
    private void init() throws IOException {
        ...
        MagnetRenderer magnetRenderer = MagnetRenderer.getsInstance();
        ...
        mLabyrinth = new Labyrinth()
                ...
                .addEntity(mBall)
                //.addEntity(new Magnet(0,0, magnetRenderer))
                .setListener(this);
    }
